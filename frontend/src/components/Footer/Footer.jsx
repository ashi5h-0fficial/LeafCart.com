                    ...
                    <MDBRow className="mt-3">
                        <MDBCol md="3" lg="3    " xl="3" className="mb-4 dark-grey-text">
                            <h6 className="text-uppercase font-weight-bold">
                                <strong>AgriCart</strong>
                            </h6>
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px" }} />
                            <p className='text-justify'>
                                The purpose of AgriCart is to provide varity of plants, gardening kits and services easily to every person fond of gardening.This website allows consumers to buy plants, services on the go and Supplier can sell their products, services to the consumers.
                            </p>
                        </MDBCol>
                        ...
                        <MDBCol md="3" lg="3" xl="4" className="mb-4 dark-grey-text">
                            ...
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px" }} />
                            <p><i className="fa fa-home mr-3" /> 2524/1, Ashirvad lodge, Prayagraj</p>
                            <p><i className="fa fa-envelope mr-3" /> info@AgriCart.com</p>
